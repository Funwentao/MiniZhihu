...
var _MyArticlePage = __webpack_require__(236);

var _MyArticlePage2 = _interopRequireDefault(_MyArticlePage);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_MyArticlePage2.default, null), document.getElementById("app"));
...
var MyArticlePage = function (_Component) {
    _inherits(MyArticlePage, _Component);

    function MyArticlePage() {
        _classCallCheck(this, MyArticlePage);

        var _this = _possibleConstructorReturn(this, (MyArticlePage.__proto__ || Object.getPrototypeOf(MyArticlePage)).call(this));
        ...
        _this._loadArticles = _this._loadArticles.bind(_this);
        return _this;
    }

    _createClass(MyArticlePage, [{
        key: '_loadArticles',
        value: function _loadArticles() {
            var that = this;
            var username = sessionStorage.getItem('__username__');
            var url = '/api/getArticles' + '?username=' + username;
